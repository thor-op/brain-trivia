...
const HomeScreen: React.FC<HomeScreenProps> = ({ user, onLogin, onLogout, onStartGame, onShowLeaderboard, onStartUsefulQuiz }) => {
            ...
            >
              {user ? (
                <div className="space-y-4">
                  ...
                  <button
                      onClick={onStartUsefulQuiz}
                      className="w-full bg-brand-cyan text-brand-black font-display text-2xl py-3 px-6 border-4 border-black shadow-hard transition-all hover:bg-cyan-200 active:shadow-none active:translate-x-1 active:translate-y-1"
                  >
                      Quiz Me on Useful Answers
                  </button>
                  <button
